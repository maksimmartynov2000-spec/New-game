...
//   — картинки — сначала кеш. Они неизменяемые: файл IMG_2427.webp всегда один и тот
//     же, перекачивать его незачем. Сюда же попадает фоновая догрузка со страницы:
//     она просто запрашивает файлы, а кладёт их в кеш этот обработчик.
//
// «Неизменяемые» — это не пожелание, а условие, на котором тут всё держится. В #173
// пять картинок заменили на новые ПОД ТЕМИ ЖЕ ИМЕНАМИ, и у ученика карточка
// «Бесконечная шоколадка» открылась с рогом Гавриила: в кеше лежала картинка
// парадокса, которого в игре уже нет. В репозитории при этом всё было верно, и
// тесты были зелёные. Новая картинка — НОВОЕ ИМЯ ФАЙЛА, старое не используется
// больше никогда. Стережёт это test/images.test.js.
//
