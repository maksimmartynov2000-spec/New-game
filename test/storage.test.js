...
// ---------- итог ----------
// Группа «Выравнивание кусочков пазла» убрана вместе с самим выравниванием: кусочки
// больше не хранятся отдельным числом, а выводятся из верных ответов по клетке, и
